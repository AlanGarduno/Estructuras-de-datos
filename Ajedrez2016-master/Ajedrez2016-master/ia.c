...
comer_pieza (struct tablero *board, int x1, int y1, int x2, int y2)
{
  ...
  if (reyjaque == 1)
      ...
      if (validar_torre == 1)
	{
      ...
      validar_torre =
	validar_movimiento_torre (board, *(pos_torre_blanca),
				  *(pos_torre_blanca + 1), *(pos_alfil_negro),
				  *(pos_alfil_negro + 1));
      if (validar_torre == 1)
	{
	  return validar_torre;	/*movimiento =
      ...
      validar_torre =
	validar_movimiento_torre (board, *(pos_torre_blanca),
				  *(pos_torre_blanca + 1), *(pos_torre_negra),
				  *(pos_torre_negra + 1));
      if (validar_torre == 1)
	{
	  return validar_torre;	/*movimiento =
      ...
      validar_torre =
	validar_movimiento_torre (board, *(pos_torre_blanca),
				  *(pos_torre_blanca + 1), *(pos_reina_negra),
				  *(pos_reina_negra + 1));
      if (validar_torre == 1)
	{
	  return validar_torre;	/*movimiento =
      ...
      if (validar_alfil == 1)
	{
      ...
      validar_alfil =
	validar_movimiento_alfil (board, *(pos_alfil_blanco),
				  *(pos_alfil_blanco + 1), *(pos_alfil_negro),
				  *(pos_alfil_negro + 1));
      if (validar_alfil == 1)
	{
	  return validar_alfil;	/*movimiento =
      ...
      validar_alfil =
	validar_movimiento_alfil (board, *(pos_alfil_blanco),
				  *(pos_alfil_blanco + 1), *(pos_torre_negra),
				  *(pos_torre_negra + 1));
      if (validar_alfil == 1)
	{
	  return validar_alfil;	/*movimiento =
      ...
      validar_alfil =
	validar_movimiento_alfil (board, *(pos_alfil_blanco),
				  *(pos_alfil_blanco + 1), *(pos_reina_negra),
				  *(pos_reina_negra + 1));
      ...
      if (validar_reina == 1)
	{
      ...
      validar_reina =
	validar_movimiento_reina (board, *(pos_reina_blanca),
				  *(pos_reina_blanca + 1), *(pos_alfil_negro),
				  *(pos_alfil_negro + 1));
      if (validar_reina == 1)
	{
	  return validar_reina;	/*movimiento =
      ...
      validar_reina =
	validar_movimiento_reina (board, *(pos_reina_blanca),
				  *(pos_reina_blanca + 1), *(pos_torre_negra),
				  *(pos_torre_negra + 1));
      if (validar_reina == 1)
	{
	  return validar_reina;	/*movimiento =
      ...
      validar_reina =
	validar_movimiento_reina (board, *(pos_reina_blanca),
				  *(pos_reina_blanca + 1), *(pos_reina_negra),
				  *(pos_reina_negra + 1));
      if (validar_reina == 1)
	{
	  return validar_reina;	/*movimiento =
...
void
cambiar (int n1, int n2, int n3, int n4, char c[4])
{
...
int
calcularvalor (int n1, int n2, int n3, int n4)
{
  int resultado = 0;
  return resultado;
}
...
int
comparar (int n1, int n2, int n3, int n4, int n5)
{
  return 0;
}
